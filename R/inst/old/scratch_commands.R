...
# move images 
moveSelectImages(num_images=200, from="../downloaders/helpers/genus_image_records/iNat_images-Stylurus-raw_images",
                 to = "../data/all_images")

moveSelectImages(num_images = 150, from="../data/all_images",
                 to = "../annotations/Jacob/")

moveSelectImages(num_images = 200, from="../data/random_images",
                 to = "../annotations/Jacob/3-2-22_NewClasses200")
...
# read in some dragonfly data
dfly_head <- read.csv(file="../data/inat_odonata_usa.csv",nrows=2000,sep="\t")

# move shared annotation class images to train set
moveAnnotationClassImages(class_col = "class", class_name = "lateral", from = "../data/random_images",
                          to = "../experiments/odo_view_classifier/dorsal_bad",
