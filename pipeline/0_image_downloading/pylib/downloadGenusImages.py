...
def downloadGenusImages(start_index,end_index,split_start=None, skip_records=False,skip_images=False,full_size=True,proj_root='../..'):
    """
       Download iNat images by genus by first downloading and splitting records, then referring to those records to download in parallel
    ...
    for i in range(start_index,end_index):
        ...
        if(not skip_records):
            ...
            subprocess.Popen(pylib_root_cmd + 'helpers\\get_inat_records.py ' + genus + ' -r --research_only'  ' -f --full_size', shell=True).wait()
