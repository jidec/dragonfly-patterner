...
def inferSegmentAnything(image_ids, model_name, image_size=344, increase_contrast=False, greyscale=False, part_suffix=None, activation_threshold=0.6, bad_hw_multiplier=4, show=False, print_steps=True, print_details=False,proj_dir="../.."):
    """
