...
image_ids = image_ids[23000:len(image_ids)]

#inferSegments(image_ids=image_ids,model_name="ant_gaster_segment",image_size=200,show=False, proj_dir="D:/ant-patterner")

extractHoneSegments(image_ids,bound=True,rotate_to_vertical=False,remove_islands=False,
                    seg_subfolder="gaster/",
