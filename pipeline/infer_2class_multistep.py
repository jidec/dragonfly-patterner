...
dorsal_non_perfect_inference = dorsal_non_inference
for i in range(1,len(dorsal_non_inference)):
    if (dorsal_non_perfect_inference[i] == "dorsal") & (dorsal_perfect_inference[i] == "perfect"):
        dorsal_non_perfect_inference[i] = "perfect"
