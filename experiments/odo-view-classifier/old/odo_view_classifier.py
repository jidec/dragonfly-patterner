...
# select dataset
train_dataset = datasets.ImageFolder("odo_view_data/train",transform=data_transforms)
test_dataset = datasets.ImageFolder("odo_view_data/test")
